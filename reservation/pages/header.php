...
<head>
	...
	<style>
        ...
        .topnav a.login:hover {
            color: #b0e6c1;
            border-bottom: 2px solid #b0e6c1;
        }

        .topnav a.login:hover + a.login {
            color: #b0e6c1;
            border-bottom: 2px solid #b0e6c1;
        }

        .topnav a.login:hover + a.login:before,
        .topnav a.login:hover + a.login:after {
            color: #b0e6c1;
        }
        ...
        .book-now-btn:hover {
            ...
            color: #ffc275;
            box-shadow: 0 0 10px rgba(27, 151, 144, 0.5);
...
<body>
	<div class="topnav">
		...
		<div class="navlinks">
			...
			<a class="navlinks" href="./room.php">Rooms</a>
			<a class="navlinks" href="./facility.php">Facilities</a>
			<a class="navlinks" href="./contact.php">Contact</a>
			<?php 
				if (isset($_SESSION['username'])) { 
					// jika user sudah login, tampilkan link logout
					echo '<a class="logout" href="../logout.php" style="margin-right: 60px;">Logout</a>';
				} else { 
					// jika user belum login, tampilkan link login
					echo '<a class="login" href="../login.php" style="margin-right: 60px;">Login</a>';
				}
			?>
		</div>
	</div>
